...
const allEvents = Array.from({ length: 24 }, (_, i) => ({
  id: i + 1,
  title: [
  ...
  location: ["San Francisco, CA", "New York, NY", "Austin, TX", "Chicago, IL", "Miami, FL", "Seattle, WA"][Math.floor(Math.random() * 6)],
...
export function EventsPage() {
  ...
  useEffect(() => {
    updateURL({ search: debouncedSearch, category, sort, location, page: page > 1 ? String(page) : "" });
  }, [debouncedSearch, category, sort, location, page, updateURL]);
